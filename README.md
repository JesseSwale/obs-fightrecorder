...
- Remove this TODO
- Make Fight recorder work when replay buffer not started
- Fightrecorder active:
  - Start replay buffer automatically
  - If fightrecorder not active, don't do anything
- obs-plugintemplate rename into obs-fightrecorder
- proper Readme
